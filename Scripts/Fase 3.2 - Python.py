...
analysis_name = "TPNL_patient_covariate"
...
def setup_model_anndata(model_class, adata, use_patient_covariate=True):
    """
...
latent_scvi.to_csv(
    os.path.join(out_dir, "latent_scVI_TPNL_patient_covariate.csv")
)

model_scvi.save(
    os.path.join(out_dir, "model_scVI_TPNL_patient_covariate"),
    overwrite = True
)
...
save_umaps(
    adata = adata_scvi,
    basis = "umap_scVI",
    prefix = "umap_scVI_TPNL_patient_covariate",
    out_dir = out_dir
)
...
compute_silhouette_scores(
    ...
    output_prefix = "scVI_TPNL_patient_covariate"
)
...
latent_ldvae.to_csv(
    os.path.join(out_dir, "latent_LDVAE_TPNL_patient_covariate.csv")
)

model_ldvae.save(
    os.path.join(out_dir, "model_LDVAE_TPNL_patient_covariate"),
    overwrite=True
)
...
loadings_df.to_csv(
    os.path.join(out_dir, "LDVAE_TPNL_patient_covariate_gene_loadings.csv")
)
...
top_genes_ldvae.to_csv(
    os.path.join(out_dir, "LDVAE_TPNL_patient_covariate_top50_genes_per_factor.csv"),
    index = False
)

"""
============================================================
3.2. Top genes positivos y negativos por factor LDVAE
============================================================
"""
...
"""
============================================================
4. Relación factores LDVAE - tejido
============================================================
"""
...
ldvae_df.to_csv(
    os.path.join(out_dir, "LDVAE_TPNL_patient_covariate_factors_with_metadata.csv")
)
...
summary_by_region.to_csv(
    os.path.join(out_dir, "LDVAE_TPNL_patient_covariate_factor_summary_by_region.csv")
)
...
summary_by_patient_region.to_csv(
    os.path.join(out_dir, "LDVAE_TPNL_patient_covariate_factor_means_by_patient_region.csv"),
    index = False
)

"""
============================================================
5. Boxplots LDVAE por región
============================================================
"""
...
for factor in factor_cols:
    ...
    plt.savefig(
        os.path.join(out_dir, f"boxplot_TPNL_patient_covariate_{safe_factor}_by_region.png"),
        dpi = 300
    )
...
save_umaps(
    adata = adata_ldvae,
    basis = "umap_LDVAE",
    prefix = "umap_LDVAE_TPNL_patient_covariate",
    out_dir = out_dir
)
...
compute_silhouette_scores(
    ...
    output_prefix = "LDVAE_TPNL_patient_covariate"
)

"""
============================================================
7. Guardar AnnData finales
============================================================
"""

adata_scvi.write_h5ad(
    os.path.join(out_dir, "adata_scVI_TPNL_patient_covariate_results.h5ad")
)

adata_ldvae.write_h5ad(
    os.path.join(out_dir, "adata_LDVAE_TPNL_patient_covariate_results.h5ad")
)
